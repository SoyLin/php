...
if(!isset($_SESSION["usuario"])) { //comprobar si ha pasado por login
	...
	$trans="0";
	$url="";
	$urlOKOK="http://192.168.206.209/Pedidos/pe_completado.php";
	$urlOKKO="http://192.168.206.209/Pedidos/pasarela_prueba.php";
	$id= 10591;
	...
	$miObj->setParameter("DS_MERCHANT_URLOK",$urlOKOK);
